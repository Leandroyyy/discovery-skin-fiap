    ...
    <HomeContainer>
      ...
      <AppInformationContainer>
        ...
        <AppInformationTitleContainer>
          ...
          <ul>
            <li>
              <FirstAid color="#FF7A00" size={32} /> Agende as suas consultas em clínicas e
              hospitais
            </li>
            <li>
              <FileSearch color="#FF7A00" size={32} /> Registre as suas manchas para observar
              padrões
            </li>
            <li>
              <ChartBar color="#FF7A00" size={32} /> Receba previsões das manchas através de IA
            </li>
            <li>
